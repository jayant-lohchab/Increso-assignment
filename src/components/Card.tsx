...
const Card = (props: Props) => {
    ...
    return (
        <>
            <div className="flex rounded-t-lg bg-gray-700 p-6 w-[800px]">
                <div className="rounded-lg bg-white h-20 w-20 flex justify-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" shape-rendering="geometricPrecision" text-rendering="geometricPrecision" image-rendering="optimizeQuality" fill-rule="evenodd" clip-rule="evenodd" viewBox="0 0 640 640">
            ...
            <div className="flex justify-between text-sm rounded-b-lg bg-gray-600 text-white h-20 p-6 w-[800px]">
